...
export default function PrendreForme() {
  return (
    <section
      ...
      className="scroll-mt-24 bg-[#E9E3D2] px-8 py-32 sm:px-12 sm:py-36 lg:px-24 lg:py-44 xl:px-36 xl:py-48"
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-5xl">
          <RevealTitle delay={0.1}>
            <h2
              ...
              className="font-serif text-[2.55rem] font-normal leading-[1.08] tracking-[-0.025em] text-[#4A413B] sm:text-[3.5rem] lg:text-[4.25rem] xl:text-[4.75rem]"
            >
          ...
          <Reveal delay={0.25}>
            <p className="mt-14 max-w-4xl font-serif text-[1.9rem] font-normal leading-[1.18] tracking-[-0.02em] text-[#62584E] sm:mt-16 sm:text-[2.75rem] lg:mt-20 lg:text-[3.5rem]">
        ...
        <div className="mt-32 grid gap-20 sm:mt-36 lg:mt-44 lg:grid-cols-[0.7fr_1.3fr] lg:items-start lg:gap-24 xl:gap-32">
          ...
          <div className="lg:pt-1">
            <ul className="space-y-7 sm:space-y-8 lg:space-y-9">
              {elements.map((element, index) => (
                <li
                  key={element}
                  className="font-serif text-[1.75rem] font-normal leading-none text-[#4A413B] sm:text-[2rem] lg:text-[2.35rem]"
                >
        ...
        <Reveal delay={0.3}>
          <div className="mt-24 max-w-xl sm:mt-28 lg:ml-auto lg:mt-36">
